...
nombre = `*${usuario}*\n✨️ Ha cambiado el nombre del grupo, Ojalá no se llame Nerv\n\n🌻 Ahora el grupo se llama:\n*${m.messageStubParameters[0]}*`
foto = `*${usuario}*\n🚩 Ha cambiado la imagen del grupo, ojalá sea de evangelion`
...
admingp = `*@${m.messageStubParameters[0].split`@`[0]}* Ahora es admin del grupo pd: si vió Evangelion 🥳\n\n💫 Acción hecha por:\n*» ${usuario}*`
noadmingp =  `*@${m.messageStubParameters[0].split`@`[0]}* Deja de ser admin del grupo pd: no vió Evangelion 😿\n\n💫 Acción hecha por:\n*» ${usuario}*`
